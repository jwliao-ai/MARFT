...
def get_custom_reward_fn(path: str, **kwargs):
    ...
    elif "multi_agent_math" in path:
        from .multi_agent import multi_agent_math_reward_fn

        return multi_agent_math_reward_fn
    elif "multi_agent_code" in path:
        from .multi_agent_code import multi_agent_code_reward_fn

        return multi_agent_code_reward_fn
    elif "codeforces" in path:
        from .multi_agent_code import multi_agent_code_reward_fn

        return multi_agent_code_reward_fn
    elif "deepcoder" in path:
        from .code_execution import deepcoder_reward_fn
