...
DENSE_MODEL_PATHS = {
    "qwen2": get_model_path(
        "/storage/cached/models/Qwen__Qwen2.5-0.5B-Instruct/",
        "Qwen/Qwen2.5-0.5B-Instruct",
    ),
    "qwen3": get_model_path(
        "/storage/cached/models/Qwen__Qwen3-0.6B/",
        "Qwen/Qwen3-0.6B",
    ),
}
...
MOE_MODEL_PATHS = {
    "qwen3_moe": get_model_path(
        "/storage/cached/models/Qwen__Qwen3-30B-A3B/",
        "Qwen/Qwen3-30B-A3B",
    ),
}
...
def load_gsm8k_samples(model_path: str, num_samples: int = 5):
    ...
    gsm8k_path = get_dataset_path("/storage/cached/data/gsm8k", "openai/gsm8k")
