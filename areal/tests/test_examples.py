...
def test_countdown_example(tmp_path_factory):
    ...
    model_path = get_model_path(
        "/storage/cached/models/Qwen__Qwen3-0.6B", "Qwen/Qwen3-0.6B"
    )
...
def test_gsm8k_grpo(tmp_path_factory, alloc_mode, single_controller):
    ...
    dataset_path = get_dataset_path("/storage/cached/data/gsm8k", "openai/gsm8k")
...
def test_vlm_grpo(tmp_path_factory):
    ...
    name_resolve_path = tmp_path_factory.mktemp("name_resolve")
    model_path = get_model_path(
        "/storage/cached/models/Qwen2.5-VL-3B-Instruct",
        "Qwen/Qwen2.5-VL-3B-Instruct",
    )
    dataset_path = get_dataset_path(
        "/storage/cached/data/BUAADreamer__clevr_count_70k",
...
def test_hhrlhf_rw(tmp_path_factory):
    ...
    dataset_path = get_dataset_path(
        "/storage/cached/data/Anthropic___hh-rlhf/", "Anthropic/hh-rlhf"
    )
...
def test_search_agent_deepresearch(tmp_path_factory):
    ...
    model_path = get_model_path(
        "/storage/cached/models/Qwen__Qwen2.5-1.5B-Instruct",
...
def test_tau2(tmp_path_factory):
    ...
    chat_template_path = "/storage/cached/data/qwen3_nonthinking.jinja"
