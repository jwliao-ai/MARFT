...
QWEN25_PATH = get_model_path(
    "/storage/cached/models/Qwen__Qwen2.5-1.5B/", "Qwen/Qwen2.5-1.5B"
)
...
QWEN25_VL_PATH = get_model_path(
    "/storage/cached/models/Qwen2.5-VL-3B-Instruct", "Qwen/Qwen2.5-VL-3B-Instruct"
)
QWEN3_VL_PATH = get_model_path(
    "/storage/cached/models/Qwen3-VL-2B-Instruct", "Qwen/Qwen3-VL-2B-Instruct"
)
GEMMA3_PATH = get_model_path(
    "/storage/cached/models/google__gemma-3-4b-it/", "google/gemma-3-4b-it"
)
