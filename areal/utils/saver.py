...
class Saver:
    ...
    def should_save(self, step: int) -> bool:
        """Check if a save should happen at this step.

        Call this once per training step, then pass force=True to save()
        for each engine to avoid double-counting the frequency control.
        """
        return self.freq_ctl.check(
